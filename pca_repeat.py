...
ens1 = parseDCD("../3_WT/4_production_repeat2/seokWT_250ns_r2_onlyProt_each25k.dcd")

str2 = parsePDB("../"+num+"_"+case+"/3_production/"+"seok"+case+"_onlyProt.pdb")
ens2 = parseDCD("../"+num+"_"+case+"/4_production_repeat2/"+"seok"+case+"_250ns_r2_onlyProt_each25k.dcd")
...
#plt.xlim(-40,40)
#plt.ylim(-30,40)
plt.savefig('../_outputs/PCA_repeat/PCA_WT_'+case+'_2D.pdf', bbox_inches = 'tight', pad_inches = 0)
